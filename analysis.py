...
plt.axline([0, 0], slope=1, color = 'lightgray', linewidth = 1, linestyle = "--")
plt.scatter(df["gq_glottolog_bin"], df["gq_glottolog_membership_mattis"], s=10)
plt.xlabel('bin')
plt.ylabel('membership_mattis')
plt.savefig(os.path.join(plots_dir, "scatter_mattis.png"))
plt.clf()
